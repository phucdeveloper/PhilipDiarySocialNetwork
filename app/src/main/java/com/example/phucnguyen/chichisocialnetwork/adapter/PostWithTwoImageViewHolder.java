...
public class PostWithTwoImageViewHolder extends PostViewHolder {

    private TextView txtNameAccount, txtTimePost, txtNumberFavorite, txtStatus, txtContentPost;
    private ImageView imgAvatar, imgLike, imgImageOne, imgImageTwo;
    ...
    public PostWithTwoImageViewHolder(@NonNull View itemView) {
        super(itemView);
