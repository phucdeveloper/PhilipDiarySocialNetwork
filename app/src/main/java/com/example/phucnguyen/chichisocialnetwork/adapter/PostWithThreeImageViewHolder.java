...
public class PostWithThreeImageViewHolder extends PostViewHolder {

    private TextView txtNameAccount, txtTimePost, txtNumberFavorite, txtStatus, txtContentPost;
    private ImageView imgAvatar, imgLike, imgImageOne, imgImageTwo, imgImageThree;
    ...
    void sendData(final Timeline timeline, final int position, final Context context, final User user) {
        ...
        Glide.with(context).load(timeline.getPostImage().getArrayList().get(2)).into(imgImageThree);
    ...
    public PostWithThreeImageViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        imgImageOne = itemView.findViewById(R.id.imageview_image_one);
        imgImageTwo = itemView.findViewById(R.id.imageview_image_two);
        imgImageThree = itemView.findViewById(R.id.imageview_image_three);
