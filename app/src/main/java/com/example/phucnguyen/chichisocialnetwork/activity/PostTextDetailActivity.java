...
public class PostTextDetailActivity extends AppCompatActivity {
    ...
    User user;
    Comment comment;
    GetDataFromFirebase getDataFromFirebase = new GetDataFromFirebase();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (timeline == null) {
            ...
            if(timeline.getPostText().getBackground() != null){
                txtContentPost.setText(timeline.getPostText().getContentPost());
                txtContentPost.setGravity(Gravity.CENTER);
                txtContentPost.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
                Glide.with(PostTextDetailActivity.this).load(timeline.getPostText().getBackground()).override(300, 500).into(imgBackground);
            }
            else{
                txtContentPost.setText(timeline.getPostText().getContentPost());
            }
